...
void	neg_slope(float m_slope, float x1, int y1, int x2, int y2, t_img img, char d, t_main *cs)
{
	float		t_slope;
	int		x;
	int		y;
...
void    pos_slope(float m_slope, float x1, int y1, int x2, int y2, t_img img, char d, t_main *cs)
{
	float		t_slope;
	int		x;
	int		y;
